...
def load_data():
    ...
    #return [graph_4_4, graph_4_5, graph_4_6, graph_4_7]
...
if __name__ == "__main__":
    ...
    #graph_4_4, graph_4_5, graph_4_6, graph_4_7 = load_data()

    # load trained model
    memory, gnn, link_pred, neighbor_loader = torch.load(f"{models_dir}/models_5per.pt",map_location=device)
